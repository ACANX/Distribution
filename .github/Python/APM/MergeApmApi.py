...
# -*- coding: utf-8 -*-
"""
MergeApmApi —— API 埋点 Data 侧批次按日聚合为 JSONL(Contents API 提交)
================================================================================
...
用法
----
    python3 .github/Python/APM/MergeApmApi.py                # 聚合"今天"
    python3 .github/Python/APM/MergeApmApi.py --date 20260629
    python3 .github/Python/APM/MergeApmApi.py --dry-run
...
# ── 路径(与原 MergeApmApi.py 的 DATA_DIR 一致) ─────────────────────────────
